...
#include <DHT.h>
#define DHTPIN 02 //pin gpio 12 in sensor
#define DHTTYPE DHT11   // DHT 22 Change this if you have a DHT11
DHT dht(DHTPIN, DHTTYPE);

// You should get Auth Token in the Blynk App.
// Go to the Project Settings (nut icon).
char auth[] = "fede4352a0fe420a8b04cfc20e56741d";  // Put your Auth Token here. (see Step 3 above)
char ssid[] = "Maker Ha Noi";
char pass[] = "makerhanoi123";
SimpleTimer timer;
